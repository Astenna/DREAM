...
Table \ref{tab:mockups_onto_requirements} depicts a mapping of system mockups onto the functional requirements. Not all the requirements could be mapped, since some of them are handled by the backend server and are not visible on the frontend side.

{
    ...
    \begin{longtable}{|*{29}{@{}C{5mm}@{}|}}
        \toprule
        & \textbf{M1} & \textbf{M2} & \textbf{M3} & \textbf{M4} & \textbf{M5} & \textbf{M6} & \textbf{M7} & \textbf{M8} & \textbf{M9} & \textbf{M10} & \textbf{M11} & \textbf{M12} & \textbf{M13} & \textbf{M14} & \textbf{M15} & \textbf{M16} & \textbf{M17} & \textbf{M18} & \textbf{M19} & \textbf{M20} & \textbf{M21} & \textbf{M22} & \textbf{M23} & \textbf{M24} & \textbf{M25} & \textbf{M26} & \textbf{M27} & \textbf{M28} \\
        \midrule
        \endhead
