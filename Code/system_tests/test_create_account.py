...
def test_create_two_policy_makers_with_the_same_data_with_error(driver):
    policy_maker = PolicyMaker(idx=2)
    test_create_policy_maker_account(driver, policy_maker, SUCCESS)
    test_create_policy_maker_account(driver, policy_maker, FAILURE)
...
def test_create_two_farmers_with_the_same_data_with_error(driver):
    farmer = Farmer(idx=2)
    test_create_farmer_account(driver, farmer, SUCCESS)
    test_create_farmer_account(driver, farmer, FAILURE)
